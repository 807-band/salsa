...
const EditStations = () => {
  ...
  return (
    <>
      ...
      <DragDropContext onDragEnd={onDragEnd(beginnerStations, advancedStations, setBeginnerStations, setAdvancedStations)}>
        <Card>
...
const onDragEnd = (beginnerStations, advancedStations, setBeginnerStations, setAdvancedStations) => (result) => {
